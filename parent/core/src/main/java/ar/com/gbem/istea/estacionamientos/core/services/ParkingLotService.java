...
public class ParkingLotService {
	...
	public List<ParkingLotDTO> getParkingLotsByUser(String subject)
			throws UserNotFoundException, ParkingLotNotFoundException {
	...
	@Transactional
	public void addParkingLot(String subject, UserResultDTO lender, List<ParkingLotDTO> parkingData)
	...
	public void updateParkingLotsBySubject(String subject) {
		List<ParkingLot> parkingLotsBySubject = parkingLotRepo.getParkingLotsBySubject(subject);
		if (parkingLotsBySubject != null) {
			for (ParkingLot parkingLot : parkingLotsBySubject) {
				solrService.post(parkingLot.getId());
			}
		}
	}
}
